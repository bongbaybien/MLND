...
class Environment(object):
    ...
    def reset(self, testing=False):
        ...
        if(self.verbose == True): # Debugging
            print "Environment.reset(): Trial set up with start = {}, destination = {}, start_heading = {}, distance = {}, deadline = {}".format(start, destination, start_heading, distance, deadline)
...
##        print ""
    ...
    def act(self, agent, action):
        ...
        if agent is self.primary_agent:
            if(self.verbose == True): # Debugging
                print "Environment.act() [PRE]: location: {}, heading: {}".format(location, heading)
        
##            print 'env.py self.agent_states[agent] before moving agent \n', state
##            pdb.set_trace()
...
##                    print '\n heading after moving \n', heading
##                    print '\n state after moving \n', state
##                    print '\n env.py self.agent_states[agent] after moving agent \n', self.agent_states[agent]
                
        # Agent attempted invalid move
        else:
##            if agent is self.primary_agent:
##                print '\n agent attempted an invalid move'
