...
def normalize(x):
    ...
    : x: List of image data.  The image shape is (width, height, color_channel)
	: color_channel = 3 for colored images, 1 for grayscale
...
# Randomize Data
# As you saw from exploring the data above, the order of the samples are randomized.  
# It doesn't hurt to randomize it again, but you don't need to for this dataset.
