...
def build_model(name, kernel_initializer=TruncatedNormal(seed=1), kernel_regularizer=None, batch_norm=False, seed=1):
	image_shape = (48,48,1)
	n_classes = 7
	model_name = name
